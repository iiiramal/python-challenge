...
csvpath = os.path.join(os.getcwd(),'Python Challenge','PyBank','Resources','budget_data.csv')
printpath = os.path.join(os.getcwd(),'Python Challenge','PyBank','Analysis','BankAnalysis.text')
